var nombre; /* Declaración de valirable nombre */
nombre = "Juan"; /*Asignación de un valor a la variable´nombre´ */
console.log(nombre);/* Muestra el valor de la variable´nombre´ */
 ...
 */
let bebida;/* Declaración de la variable */
bebida = "coca-cola";/* Asignación de un valor a la variable bebida */
console.log(bebida);/* Muestra el valor de la variable bebida */

let bebida="fanta";/* <easignación> de un valor a la variable bebida */
console.log(bebida);/* Muestra el valor de la variable bebida */

let bebida="sprite";/* <easignación> de un valor a la variable bebida */
console.log(bebida);/* Muestra el valor de la variable bebida */
